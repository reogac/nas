...
// security header
const (
	NasSecNone         uint8 = 0x00
	NasSecIntegrity    uint8 = 0x01
	NasSecBoth         uint8 = 0x02
	NasSecIntegrityNew uint8 = 0x03
	NasSecBothNew      uint8 = 0x04
)
...
// uplink transport container type
const (
